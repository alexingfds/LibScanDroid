...
class Evaluation:
    ...
    def averagePuc(self,listofpattern):
        ...
        if (len(listofpattern) > 0):
            ...
            append_list_as_row('pucrecordboucle.csv', [self.maxepsilon, self.minpoint, self.nbrlibrary, self.nbrapplication,self.stepepsilon,len(listofpattern),str(AveragePuc),datetime.now()])
