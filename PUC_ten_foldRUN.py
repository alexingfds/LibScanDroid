...
from PUCrossEvaluation import PUCrossEvaluation
...
if __name__ == "__main__":
    ...
    for fold in namesfoldValidANDnamesfoldTraining:
            ...
            resulforevaluation = PUCrossEvaluation(fold, arraysource, maxEpsilon, dictlibrary, resultdbscan, minpt, nbrlibrary,
