...
namesfoldValid =['fold_1valid.csv','fold_2valid.csv','fold_3valid.csv','fold_4valid.csv','fold_5valid.csv','fold_6valid.csv','fold_7valid.csv','fold_8valid.csv','fold_9valid.csv','fold_10valid.csv']
